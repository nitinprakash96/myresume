...
\begin{entrylist}
  ...
  \entry
    ...
    {Webmaster}
    {LNMIIT}
    {Designed and developed LNMIIT's student branch website for IEEE chapter which again used HTML, CSS, Bootstrap, JS and JQuery. Rest was the backend which was done in PHP integrated with MySQL database connectivity.}
\end{entrylist}
\\
\section{Education}
\begin{entrylist}
...
\begin{entrylist}
  ...
  \entry
    ...
    {IEEE}
    {IEEE}
    {Assigned a position in IEEE core committee and AISYWC'16 organising team to look upon the future technical regards upon the concerned matter.}
\end{entrylist}
